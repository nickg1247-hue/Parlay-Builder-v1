    ...
    *,
    ...
    for raw_game in schedule_games:
        ...
        row: dict[str, Any] = {
            ...
            "model_eligible": bool(pred) or bool(game.get("model_eligible")),
            ...
            "raw_model_prob_home": pred.get("raw_model_prob_home"),
            "raw_model_prob_away": pred.get("raw_model_prob_away"),
            "display_probability_capped": pred.get("display_probability_capped",False),
            "display_probability_cap_reason": pred.get("display_probability_cap_reason"),
            "candidate_tier": pred.get("candidate_tier"),
            "tier_validated": pred.get("tier_validated"),
            "public_tier_label": pred.get("public_tier_label"),
            "tier_status_label": pred.get("tier_status_label"),
            "tier_validation_reason": pred.get("tier_validation_reason"),
            "tier_policy_version": pred.get("tier_policy_version"),
            "tier_evidence": pred.get("tier_evidence"),
            "experimental": bool(pred.get("experimental")),
